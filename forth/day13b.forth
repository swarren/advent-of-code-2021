...
: apply-cmds
    ( list-dots list-cmds/cmd-node-ptr-ptr )
    begin
        ( list-dots cmd-node-ptr-ptr )
        @
        ( list-dots cmd-node-ptr )
        dup 0= invert
        ( list-dots cmd-node-ptr !is-null )
    while
        ( list-dots cmd-node-ptr )
        2dup swap
        ( list-dots cmd-node-ptr cmd-node-ptr list-dots )
        apply-cmd-all-dots
        ( list-dots cmd-node-ptr )
        dot-node-next
        ( list-dots next-cmd-node-ptr-ptr )
    repeat
    ( list-dots cmd-node-ptr )
    2drop
    ( )
...
list-dots vt100-print-list-dots
